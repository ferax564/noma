...
- **Enterprise workspace product UI:** a real Docs / Visuals / Work shell — floating liquid-glass chrome over a luminous mesh, Framer-like motion, a paper editor with hosted Tiptap/Yjs, PaperDOM canvas frames, and a live issue board — served at `/` from the enterprise HTTP server.
